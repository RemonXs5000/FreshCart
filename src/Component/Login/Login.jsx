...
export default function Login() {
  ...
  function loginUser(UserData){
    setIsloading(true)
    axios.post('https://ecommerce.routemisr.com/api/v1/auth/signin',UserData).then(data=>{
  ...
  <div className='w-1/2 mx-auto my-10'>
    <div className='text-center my-8'> 
      ...
      <h4 className='text-xl text-slate-500 '>Log In with Account</h4>
    </div>
  ...
  {APImsg ? <div className="p-4 mb-4 text-sm text-black rounded-lg bg-red-200 dark:bg-blue-800-800 dark:text-white" role="alert">{APImsg}</div> : null }
  <button type='submit' className='bg-emerald-700 py-3 px-4 text-white font-semibold rounded-md hover:bg-[#4FA74F]' >{ Isloading ? <i className="fa-duotone fa-solid fa-spinner animate-spin"></i>  : "Login" }</button>
  <span onClick={handleForgetPassword} className='font-semibold text-slate-500 hover:text-black text-[15px] cursor-pointer block my-2'>Forgot Your password</span>
</form>
